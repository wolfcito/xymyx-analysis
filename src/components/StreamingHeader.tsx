...
const StreamingHeader: React.FC = () => {
  return (
    <header className="streaming-header geometric-bg h-14 lg:h-16 flex items-center justify-between px-4 lg:px-6">
      ...
      <div className="flex items-center space-x-3 lg:space-x-6">
        <div className="flex items-center space-x-2 lg:space-x-3">
          ...
          <h1 className="text-lg lg:text-2xl font-bold neon-text">XYMYX ANALYZER</h1>
        </div>
      ...
      <div className="flex items-center space-x-2 lg:space-x-4">
        <div className="flex items-center space-x-1 lg:space-x-2">
          ...
          <span className="text-white font-medium text-xs lg:text-sm hidden sm:block">@xymyx</span>
        </div>
